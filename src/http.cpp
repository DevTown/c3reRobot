...
static esp_err_t cmd_handler(httpd_req_t *req)
{
    ...
    {
      ledcWrite(7,val);
      Serial.println("flashlight on :" + val);
    }  
    ...
    <br>
        <section class="main">
            <section id="buttons">
                ...
                <tr>
          <td>FlashLight</td>
          <td align="center" colspan="2"><input type="range" id="lamp" min="0" max="100" value="0" 
            onchange="try{fetch(document.location.origin+'/control?var=flash&val='+this.value);}catch(e){}"></td>
        </tr>
                </table>
            </section>         
        </section>
